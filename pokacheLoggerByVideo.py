...
path = '/content/gdrive/Othercomputers/マイ パソコン/GoogleDrive(tonomotohide)/pokerchase/pokache_full.mp4'
...
while True:
    ...
    # ex. PokerChase Game #20220626142512: Tournament #20220626142512, $20.0$0.00 Hold'em No Limit - Level V (390/780) - 2022/06/26 14:25:12JST
    ...
    # ex. Table '160417133 3' 9-max Seat #8 is the button
